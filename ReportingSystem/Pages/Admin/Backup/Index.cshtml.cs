...
namespace ReportingSystem.Pages.Admin.Backup;
...
public class IndexModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostRestoreAsync(int id)
    {
        try
        {
            ...
            if (success)
            {
                SuccessMessage = $"Database restored from backup '{backup.Name}'. Please restart the application for changes to take full effect.";
            }
            else
            {
    ...
    public async Task<IActionResult> OnPostWalCheckpointAsync()
    {
        try
        {
            ...
            {
                SuccessMessage = $"Database cleanup completed successfully! Space reclaimed: {result.SpaceReclaimedFormatted}.";
            }
