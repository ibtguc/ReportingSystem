...
/// <summary>
/// IMPORTANT: Represents time CONSTRAINTS/PREFERENCES for rooms (from UNTIS GPU016.TXT)
/// Negative values = AVOID scheduling, Positive values = TRY TO schedule
///
/// UNTIS Constraint/Preference Scale:
/// -3: AVOID scheduling (strongest - highest penalty, e.g., scheduled maintenance)
...
public class RoomAvailability
{
    ...
    /// <summary>
    /// UNTIS importance/constraint scale: -3 (prefer NOT to use) to +3 (MUST use)
    /// NEGATIVE values = unavailability/constraints (avoid using room)
    /// POSITIVE values = preferences/requirements (prefer using room)
    /// </summary>
    [Required]
    [Range(-3, 3)]
